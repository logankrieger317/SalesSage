      ...
      <div className={`bg-green-100 dark:bg-green-900 flex flex-column p-4 m-4 rounded-2xl items-center content-center justify-center shadow-xl`}>
        <Switch.Group as="div" className="flex items-center justify-between">
          <span className="flex flex-grow flex-col">
            <Switch.Label as="span" className="text-sm font-medium leading-6 text-gray-900 dark:text-gray-100" passive>
              Dark Mode
            </Switch.Label>
            <Switch.Description as="span" className="text-sm text-gray-500 dark:text-gray-300">
